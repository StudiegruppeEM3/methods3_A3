...
log2prob(3.5637-0.5223*10)

log2prob(11.007982+0.8622*3)

exp(3.5637-0.5223*10)/(1+exp(3.5637-0.5223*10))
#when ados = 10 the model predicts that there is 16% chance of that child #being TD.
